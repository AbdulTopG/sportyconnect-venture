        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-sportyfi-orange transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-sportyfi-orange transition-colors">Terms of Service</a></li>
            </ul>
          </div>
