        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Button variant="outline" onClick={handleHostMatch} className="border-white font-semibold h-14 text-lg w-full flex gap-2 text-slate-50 bg-sportyfi-orange">
                <Calendar size={20} />
                Host a Match
              </Button>
              ...
              <Button variant="outline" onClick={handleGroundsBooking} className="border-white text-white font-semibold h-14 text-lg w-full flex items-center gap-2 bg-sportyfi-orange">
                <Map size={20} />
                Grounds Booking
              </Button>
            </div>
